...
!function(a){a(function(){a('[data-toggle="password"]').each(function(){var b = a(this); var c = a(this).parent().find(".input-group-text"); c.css("cursor", "pointer").addClass("input-password-hide"); c.on("click", function(){if (c.hasClass("input-password-hide")){c.removeClass("input-password-hide").addClass("input-password-show"); c.find(".fa").removeClass("fa-eye").addClass("fa-eye-slash"); b.attr("type", "text")} else{c.removeClass("input-password-show").addClass("input-password-hide"); c.find(".fa").removeClass("fa-eye-slash").addClass("fa-eye"); b.attr("type", "password")}})})})}(window.jQuery);
  ...
  <body>
      <nav class="navbar navbar-expand-sm navbar-light bg-white">
        ...
        <div class="container-fluid ">
          <?php
          require_once $_SERVER['DOCUMENT_ROOT'].'/outreach/resource/php/function/addAccount.php';
          if(isset($_POST['save'])){
            $edit = new addAccount($_POST['username'],$_POST['password'],$_POST['email'],$_POST['status']);
            $edit->addAccountUser();
            ?>
            <div class="alert alert-success alert-dismissible fade show animated fadeInDown mt-4 mb-0" role="alert">
            You successfully added account!
          ...
          <div class="row justify-content-center">
            <div class="col-md-5 mt-5">
              ...
              -moz-box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                  <div class="card-header text-white bg-white"><h2 style="color:#d75093">Add Account</h2></div>
                    <div class="card-body">
                      <form method="POST" action="" enctype="multipart/form-data">
                        <div class="form-group">
                        <label for="username" class="col-form-label text-md-right">Username</label>
                        <input id="username" type="text" class="form-control" name="username" placeholder="Username" required autocomplete="off">
                        </div>
                        <label for="password" class="col-form-label text-md-right">Password</label>
                        <div class="input-group">
                          <input type="password" name="password" id="password" class="form-control" data-toggle="password" placeholder="Password" required autocomplete="off">
                        ...
                        <select id="status" class="form-control mr-2 browser-default custom-select" name="status" required>
                        ...
                        <input id="email" type="text" class="form-control " name="email" placeholder="Email" required autocomplete="off">
                          ...
                          <div class="form-group row justify-content-center">
                            <div class="col-md-12 text-center">
                              <button type="submit" class="card-btn btn text-light mt-3" style="background-color:#d75093" name="save">Add</button>
                            </div>
                          </div>
                        </form>
                      </div>
