...
<body>
        <nav class="navbar navbar-expand-sm navbar-light bg-white">
          <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav ml-auto">
                    <form action="" method="GET" class="form-inline my-2 my-lg-0">
                      <li class="nav-item"><a class="nav-link text-dark mr-2 mt-3" href="dataTableParticipant_student.php"><span style="color:#d75093"><i class="fas fa-chart-bar" ></i> Analytics</span></a></li>
                      <li class="nav-item"><a class="nav-link text-dark mr-2 mt-3" href="viewParticipants_student.php?pg=participant"><span style="color:#d75093"><i class="fas fa-user-friends"></i> View Participants</span></a></li>
                      ...
                      <button class="btn btn-secondary dropdown-toggle text-dark mt-3" style="background-color: transparent; border: none;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                          ...
                          echo '<a class="dropdown-item py-2" href="editParticipantAcc_student.php?account_id='.$account_id.'"><span style="color:#d75093"><i class="fas fa-user-edit mr-1"></i>Edit Account</span></a>';
                          ?>
            ...
            <a type="submit" name="activity" href="activity_student.php" class="btn btn-default my-3 mr-3 text-light float-right" style="background-color:#d75094"><i class="fas fa-pen-nib mr-2"></i>Activity</a>
          ...
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade animated fadeInUp <?php if(empty($_GET['tab'])){echo "active";}elseif($_GET['tab']=="all"){echo "active";}?>" id="nav-all" role="tabpanel" aria-labelledby="nav-all-tab">
              <?php
              require_once $_SERVER['DOCUMENT_ROOT'].'/outreach/resource/php/function/view_student.php';
              $view = new view;
