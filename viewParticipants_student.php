  ...
  <body>
    <nav class="navbar navbar-expand-sm navbar-light bg-white">
              ...
              <ul class="navbar-nav ml-auto">
                <form action="" method="GET" class="form-inline my-2 my-lg-0">
                  ...
                  if (!empty($_GET['pg'])) {
                   ...
                   if ($pg == 'activity') {
                    ?>
                    href="activity_student.php"
                    <?php
                  }elseif ($pg == 'participant') {
                    ?>
                    href="participant_student.php"
                    <?php
                  }
                  ?>
      ...
      <div class="container-fluid mt-4 ">
        ...
        <input type="submit" name="submit"value="Search"style="background:none;border:0;color:white;background-color:#d75094;">
          ...
          <a class="btn text-white" style="background-color:#d75094;" <?php
           if ($pg == 'activity') {
            ?>
            href="viewParticipants_student.php?pg=activity"
            <?php
          }elseif ($pg == 'participant') {
            ?>
            href="viewParticipants_student.php?pg=participant"
            <?php
          }
          ?>>Clear</a>
          </form>
      ...
      <div class="container animated fadeInUp">
        ...
        <?php
        require_once $_SERVER['DOCUMENT_ROOT'].'/outreach/resource/php/function/searchProfile_student.php';
