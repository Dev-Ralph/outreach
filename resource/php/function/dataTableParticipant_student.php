...
public function dataTableDepartmentLiteracy(){
            ...
            echo '<td class="text-center"><a class="btn btn-outline-primary" href="tableDepartmentParticipant_student.php?department='.$result->collegeDepartment.'&type='.$result->type.'"><i class="fas fa-eye mr-1"></i>View</td>';
            echo '</tr>';
            }
            echo '</table>';
}
