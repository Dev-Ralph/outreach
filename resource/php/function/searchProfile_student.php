...
public function viewAll(){
            ...
            echo '<td class="text-center"> <a class="btn btn-outline-primary" href="viewProfile_student.php?pg='.$pg.'&schl_number='.$result->schl_number.'&type='.$result->type.'""><i class="fas fa-eye mr-1"></i>View</a></td>';
            echo '</tr>';
            }
            echo '</table>';
