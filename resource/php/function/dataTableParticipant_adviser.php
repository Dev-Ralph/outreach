...
public function dataTableProponentLiteracy(){
            ...
            echo '<td class="text-center py-3"><a class="btn btn-outline-primary" href="tableActivityParticipant_adviser.php?act_title='.$result->title.'&act_date='.$result->date.'"><i class="fas fa-eye mr-1"></i>View</a></td>';
            echo '</tr>';
            }
            echo '</table>';
            ...
            <a class="btn text-light py-2" href="dataTableParticipant_adviser.php?pill=literacy&tab=activity" style="background-color: #d75093;">Clear</a>
            </div>
            </form>';
}
...
public function dataTableProponentHealth(){
            ...
            <a class="btn text-light py-2" href="dataTableParticipant_adviser.php?pill=health&tab=activity" style="background-color: #d75093;">Clear</a>
            </div>
            </form>';
}
...
<label class="col-form-label text-md-right">To: </label>
            ...
            <a class="btn text-light py-2" href="dataTableParticipant_adviser.php?pill=environment&tab=activity" style="background-color: #d75093;">Clear</a>
            </div>
            </form>';
}
...
<label class="col-form-label text-md-right">To: </label>
            ...
            <a class="btn text-light py-2" href="dataTableParticipant_adviser.php?pill=livelihood&tab=activity" style="background-color: #d75093;">Clear</a>
            </div>
            </form>';
}
