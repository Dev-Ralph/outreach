...
public function viewAll(){
              ...
              echo  '<td class="text-left"> <a class="btn btn-outline-primary" href="viewData_student.php?outreach_activity_id='.$result->outreach_activity_id.'&act_title='.$result->title.'&act_date='.$result->date.'""><i class="fas fa-eye mr-1"></i>View</a> <a class="btn btn-outline-primary" href="tableActivity2_student.php?act_title='.$result->title.'&act_date='.$result->date.'""><i class="fas fa-users mr-2"></i>Participants</a></td>';
              echo '</tr>';
              }
              echo '</table>';
              ...
              <input type="submit" name="submit-all"value="Search"style="background:none;border:0;color:white;background-color:#d75094;">
                ...
                <a class="btn text-white mt-3" style="background-color:#d75094;" href="activity_student.php">Clear</a>
                </form>';
}
public function viewAllLiteracy(){
            ...
            echo '<td class="text-left">'.$result->mean.'</td>';
            echo '<td class="text-left">'.$result->interpretation.'</td>';
            echo  '<td class="text-left"> <a class="btn btn-outline-primary" href="viewData_student.php?outreach_activity_id='.$result->outreach_activity_id.'""><i class="fas fa-eye mr-1"></i>View</a> <a class="btn btn-outline-primary" href="tableActivity2_student.php?act_title='.$result->title.'&act_date='.$result->date.'""><i class="fas fa-users mr-2"></i>Participants</a></td>';
            echo '</tr>';
            }
            echo '</table>';
