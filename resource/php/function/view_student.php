...
class view extends config {
  public function viewAll(){
              ...
              echo '<th class="text-left">Activity</th> <th class="text-left">Date</th> <th class="text-left">Participant</th> <th class="text-left">ID Number</th> <th class="text-left">Participation</th> <th class="text-left">College Department</th> <th class="text-left">Proponent</th>';
              echo '</tr>';
              ...
              <input type="submit" name="submit-all"value="Search"style="background:none;border:0;color:white;background-color:#d75094;">
                ...
                <a class="btn text-white mt-3" style="background-color:#d75094;" href="participant_student.php">Clear</a>
                </form>';
}
