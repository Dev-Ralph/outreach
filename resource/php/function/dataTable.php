...
public function dataTableDepartmentLiteracy(){
            ...
            echo '<td class="text-center"><a class="btn btn-outline-primary" href="tableDepartment.php?pg='.$pg.'&department='.$result->collegeDepartment.'&type='.$result->type.'"><i class="fas fa-eye mr-1"></i>View</td>';
            echo '</tr>';
            }
            echo '</table>';
}
...
public function dataTableProponentLiteracy(){
            ...
            for ($p=1; $p <= $total_pages; $p++) {
              ...
              echo  '<a class="page-link" href="?pg='.$pg.'&pill=literacy&tab=activity&page='.$p.'">'.$p;
              echo  '</a>';
              echo '</li>';
            }
            echo '</ul>';
...
public function dataTableProponentHealth(){
            ...
            for ($p=1; $p <= $total_pages; $p++) {
              echo '<li class="page-item" style="display: inline-block;margin-left:4px;">';
              echo  '<a class="page-link" href="?pg='.$pg.'&pill=health&tab=activity&page='.$p.'">'.$p;
              echo  '</a>';
              echo '</li>';
            }
            echo '</ul>';
...
public function dataTableProponentEnvironment(){
            ...
            for ($p=1; $p <= $total_pages; $p++) {
              echo '<li class="page-item" style="display: inline-block;margin-left:4px;">';
              echo  '<a class="page-link" href="?pg='.$pg.'&pill=environment&tab=activity&page='.$p.'">'.$p;
              echo  '</a>';
              echo '</li>';
            }
            echo '</ul>';
...
public function dataTableProponentLivelihood(){
            ...
            for ($p=1; $p <= $total_pages; $p++) {
              echo '<li class="page-item" style="display: inline-block;margin-left:4px;">';
              echo  '<a class="page-link" href="?pg='.$pg.'&pill=livelihood&tab=activity&page='.$p.'">'.$p;
              echo  '</a>';
              echo '</li>';
            }
            echo '</ul>';
