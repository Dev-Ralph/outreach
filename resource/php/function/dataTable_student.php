...
public function dataTableDepartmentLiteracy(){
            ...
            echo '<td class="text-center"><a class="btn btn-outline-primary" href="tableDepartment_student.php?department='.$result->collegeDepartment.'&type='.$result->type.'"><i class="fas fa-eye mr-1"></i>View</td>';
            echo '</tr>';
            }
            echo '</table>';
}
...
public function dataTableProponentLiteracy(){
            ...
            echo '<td class="text-center py-3"><a class="btn btn-outline-primary" href="tableActivity_student.php?act_title='.$result->title.'&act_date='.$result->date.'"><i class="fas fa-eye mr-1"></i>View</a></td>';
            echo '</tr>';
            }
            echo '</table>';
            ...
            <a class="btn text-light py-2" href="dataTable_student.php" style="background-color: #d75093;">Clear</a>
            </div>
            </form>';
}
